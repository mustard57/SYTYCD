...
module namespace ext = "http://marklogic.com/rest-api/resource/rdbms2triples";
...
(:
 : Perform a batch of database ingest functionality given the specified json/xml configuration options
 :)
declare 
%roxy:params("uri=xs:string", "collection=xs:string")
function ext:post(
