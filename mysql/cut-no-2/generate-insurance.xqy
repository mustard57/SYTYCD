...
declare variable $schema-file := "c:\Users\ktune\SYTYCD-Dummy-Data\mysql\cut-no-1\sytycd.insurance.schema.sql";
...
<root>
    ...
    <table rows="519">
        ...
        <pkey content="counter:1017">auto</pkey>
        <fields>
    ...
    <data rows="353">
        ...
        <pkey>auto</pkey>
        <fields>
            <fkey content="counter:0">CONTRACT</fkey>            
    ...
    <data rows="322">
        <table-name>CONTRACT</table-name>
        <pkey content="counter:353">POLICY-ID</pkey>
        <fields>
    ...
    <data rows="167">
        <table-name>CONTRACT</table-name>
        <pkey content="counter:675">POLICY-ID</pkey>
        <fields>
